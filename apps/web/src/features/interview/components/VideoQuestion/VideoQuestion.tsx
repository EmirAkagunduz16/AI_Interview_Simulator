...
const VideoQuestion = () => {
  ...
  useEffect(() => {
    const startWebcam = async () => {
      try {
        ...
        setError(
          "Kamera ve mikrofon erisimi reddedildi. Lutfen tarayici ayarlarindan izin verin.",
        );
      }
    };
  ...
  useEffect(() => {
    ...
    const initializeInterview = async () => {
      ...
      const questionText =
        currentQuestion?.text || "Kendinizi tanitir misiniz?";
    ...
    <div className="video-question">
      ...
      <div className="video-question__content">
        ...
        <div className="video-question__phase">
          ...
          <span className="video-question__phase-text">
            {getPhaseMessage()}
          </span>
        </div>
          ...
          <div className="video-question__ai-panel">
            <div className="video-question__ai-header">
              <div className="video-question__ai-avatar">
                ...
                {isSpeaking && (
                  <span className="video-question__speaking-dot" />
                )}
              </div>
            ...
            <div className="video-question__ai-message">
              ...
              {isSpeaking && (
                <button
                  className="video-question__skip-btn"
          ...
          <div className="video-question__history">
            ...
            <div className="video-question__history-list">
              {conversationHistory.map((item, index) => (
                <div
                  key={index}
                  className={`video-question__history-item ${item.role}`}
                >
                  <span className="video-question__history-role">
                    {item.role === "ai" ? "AI" : "Siz"}:
                  </span>
                  <span className="video-question__history-text">
                    {item.text}
                  </span>
                </div>
              ))}
